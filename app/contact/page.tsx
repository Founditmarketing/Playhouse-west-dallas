...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result.success) {
        // 1. GTM dataLayer push — always fires first, isolated in its own try/catch
        //    so a downstream pixel failure can never suppress this conversion event.
        try {
          if (typeof window !== 'undefined') {
          ...
          console.error('GTM dataLayer push failed:', gtmErr)
        }

        // 2. Facebook Pixel — guarded separately; if fbq isn't loaded yet this is a no-op.
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Script id="fb-viewcontent-contact" strategy="afterInteractive">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:Playhousewestdallas@gmail.com"
                        className="text-primary hover:text-accent text-sm transition-colors"
                      >
                        Playhousewestdallas@gmail.com
                      </a>
                    </div>
                  </div>

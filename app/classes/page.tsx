...
export default function ClassesPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Script id="fb-viewcontent-classes" strategy="afterInteractive">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 border border-zinc-200 shadow-sm flex flex-col h-full">
                ...
                <ul className="list-disc pl-5 space-y-3 text-slate-700 text-sm md:text-base leading-relaxed">
                  ...
                  <li><strong>Tuesdays:</strong> 6:00 PM – 9:00 PM</li>
                  <li><strong>Saturdays:</strong> 12:00 PM – 3:00 PM</li>
        ...
        {/* Closing CTA */}
        <section className="bg-zinc-900 text-white py-12 md:py-16 border-t border-zinc-800 text-center">
          <div className="max-w-[800px] mx-auto px-6">
            <div className="space-y-8">
              <h2 className="font-serif text-3xl md:text-5xl uppercase tracking-widest text-white">
                Take the First Step
              </h2>
              <p className="text-zinc-400 text-lg md:text-xl max-w-[600px] mx-auto leading-relaxed">
                Experience authentic Meisner training firsthand. Audit a class to witness the work, meet the instructors, and see if our program is right for you.
              </p>
              <div className="pt-6">
                <Link
                  href="/audit-1"
                  className="inline-block bg-primary text-white font-serif uppercase tracking-widest px-12 py-5 hover:bg-white hover:text-primary transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  Audit a Class
                </Link>
              </div>
